...
m <- read.table(paste0(dir,"merged_counts_core_calcifiers.txt"), header=T)
control.name =  "MMETSP1363"
...
write.table(norm.data, paste0(dir,"norm_RNAseq_log2ratios_calcifiers.tsv"), sep="\t")
