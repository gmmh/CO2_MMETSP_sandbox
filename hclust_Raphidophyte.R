...
data.dir <- "~/Desktop/CO2_MMETSP/Ochrophyta/counts/"
data <- read.table(paste0(data.dir, "norm_RNAseq_log2ratios_Raph.tsv"), header=T)
control = "MMETSP0292"
co2 = "MMETSP0296"
...
write.table(out, file=paste0(data.dir,"core_clusters_Raph", Sys.Date(),".txt"), row.names=F, col.names=F, quote=F)
