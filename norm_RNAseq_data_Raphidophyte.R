...
m <- read.table(paste0(dir,"merged_counts_core_Raph.txt"), header=T)
control.name =  "MMETSP0292"
...
write.table(norm.data, paste0(dir,"norm_RNAseq_log2ratios_Raph.tsv"), sep="\t")
