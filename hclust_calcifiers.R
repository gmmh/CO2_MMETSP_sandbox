...
data <- read.table(paste0(data.dir, "norm_RNAseq_log2ratios_calcifiers.tsv"), header=T)
control = "MMETSP1363"
co2 = "MMETSP1364"
...
#make heatmap plot
pdf(file= paste0(data.dir,"heatmap_calcifiers.pdf"))
...
write.table(out, file=paste0(data.dir,"core_clusters_calcifiers", Sys.Date(),".txt"), row.names=F, col.names=F, quote=F)
